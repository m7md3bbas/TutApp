  ...
  return ThemeData(
    ...
    textTheme: TextTheme(
        ...
        headlineMedium: getRegularStyle(
            color: ColorManager.darkGrey, fontSize: FontSizes.s14),
        titleMedium: getMediumStyle(
            color: ColorManager.primary, fontSize: FontSizes.s16),
    ...
    inputDecorationTheme: InputDecorationTheme(
        ...
        labelStyle:
            getMediumStyle(color: ColorManager.grey, fontSize: FontSizes.s14),
